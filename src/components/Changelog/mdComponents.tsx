...
import { PostDetailsInfo, PostDetailsInfoContainer } from './PostDetailsInfo';
...
const MdComponents = (): any => ({
	...
	video: (props: any) => <video className="rounded-xl" {...props} />,
	pre: (props: any) => <PreCodeBlock {...props} />,
	PostInfoContainer,
	postinfo: (props: React.ComponentProps<typeof PostInfo>) => (
		<PostInfo {...props} />
	),
	PostInfo: (props: React.ComponentProps<typeof PostInfo>) => (
		<PostInfo {...props} />
	...
	PostDetailsInfo: (props: React.ComponentProps<typeof PostDetailsInfo>) => (
		<PostDetailsInfo {...props} />
	),
})
